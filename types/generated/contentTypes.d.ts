...
export interface ApiChannelChannel extends Schema.CollectionType {
  ...
  attributes: {
    ...
    stream_key: Attribute.Text;
    total_income: Attribute.Decimal;
    email: Attribute.String;
    password: Attribute.String;
    OTP_link: Attribute.String;
    email_password: Attribute.String;
...
export interface ApiRdpRdp extends Schema.CollectionType {
  ...
  attributes: {
    vps_id: Attribute.String;
    vps_name: Attribute.String;
    vps_ip: Attribute.String;
    vps_status: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiStreamStream extends Schema.CollectionType {
  ...
  attributes: {
    stream_id: Attribute.String;
    stream_name: Attribute.String;
    channel: Attribute.Relation<
      'api::stream.stream',
      'oneToOne',
      'api::channel.channel'
    >;
    rdp: Attribute.Relation<'api::stream.stream', 'oneToOne', 'api::rdp.rdp'>;
    start_date_time: Attribute.DateTime;
    stop_date_time: Attribute.DateTime;
    stream_status: Attribute.Enumeration<['ONSTREAM', 'PENDING', 'FINISHED']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
